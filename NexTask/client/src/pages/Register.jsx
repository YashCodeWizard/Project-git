  ...
  return (
    <div className='flex h-screen flex-col items-center justify-center'>
            <div className='w-[60vw] md:w-[50vw] lg:w-[30vw]'>
                ...
                <h3 className='text-center font-semibold text-xinc-900'>Register with NextTask</h3>
            </div>
            <div className='w-[60vw] md:w-[50vw] lg:w-[30vw] mt-4'>
            <form className='flex flex-col gap-4' >
                <input type="text" required placeholder='username' className='border rounded px-4 py-1 border-zinc-400 w-[100%] outline-none' name='username'  value={Values.username} onChange={change}/>
